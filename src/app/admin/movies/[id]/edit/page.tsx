  ...
  useEffect(() => {
    async function fetchMovie() {
      try {
        ...
        if (!response.ok) throw new Error(data.error || 'Failed to fetch movie');
  ...
  return (
    <div>
      <div className="mb-8 flex items-center gap-4">
        ...
        <div>
          <h1 className="font-display text-3xl font-bold text-white">Edit Movie</h1>
          <p className="mt-1 text-matte-400">Update movie information</p>
        </div>
      </div>
