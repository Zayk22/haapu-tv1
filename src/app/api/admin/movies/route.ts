...
// Blocks access only when role is explicitly set to a non-admin value.
// If role is undefined (Clerk JWT template not configured yet), allows through.
// This prevents lockout during setup while still enforcing roles once configured.
