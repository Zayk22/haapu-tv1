      ...
      <SignUp
        ...
        appearance={{
          elements: {
            ...
            // Hint text — "8 characters minimum", password strength etc
            ...
            unstable__formFieldInputGroup: "bg-matte-800",
            formFieldInputGroup: "bg-matte-800 border-matte-700",
            ...
            passwordStrengthMeterFillBlock:
              "rounded-full",
          },
        }}
      />
