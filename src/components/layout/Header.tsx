        ...
        <div className="mx-auto flex max-w-screen-2xl items-center justify-between px-4 py-3 lg:px-12 lg:py-4">
          ...
          <div className="flex items-center gap-4">
            ...
            <SignedIn>
              <Link
                href="/watchlist"
                className={`hidden lg:flex h-10 w-10 items-center justify-center rounded-full transition-all ${
              ...
              <div className="relative" ref={dropdownRef}>
                ...
                >
                  {/* Avatar */}
                  <div
                    className="relative h-9 w-9 overflow-hidden rounded-full flex-shrink-0 border border-white/10"
                ...
                {accountOpen && (
                  <div className="absolute right-0 top-full mt-2 w-64 overflow-hidden rounded-xl border border-matte-800 bg-matte-900/98 shadow-2xl backdrop-blur-md z-50">
                    ...
                    <div className="flex items-center gap-3 border-b border-matte-800 px-4 py-3">
                      <div
                        className="h-11 w-11 overflow-hidden rounded-full flex-shrink-0 border border-white/10"
                        style={{ backgroundColor: "#E50914" }}
                      >
                        {avatarUrl ? (
                          <img src={avatarUrl} alt={displayName} className="h-full w-full object-cover" />
